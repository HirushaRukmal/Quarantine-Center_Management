...
exports.create = (req, res) => {
  ...
  if (validator.validate(email)) {
    ...
    const improvedAdjectives = [...names, firstName];
    const xMen = [middleName];
    const xWomen = [lastName];
...
exports.readById = (req, res) => {
  ...
  Employee.findOne({ employeeId }).exec((err, employee) => {
    if (err) console.log(err);
    res.json(employee);
  });
};
...
exports.readByUsername = (req, res) => {
  ...
  Employee.findOne({ username }).exec((err, employee) => {
    if (err) console.log(err);
    res.json(employee);
  });
};
...
exports.readByMobile = (req, res) => {
  ...
  Employee.findOne({ mobileNumber }).exec((err, employee) => {
    if (err) console.log(err);
    res.json(employee);
  });
};
...
exports.readByNIC = (req, res) => {
  ...
  Employee.findOne({ NIC }).exec((err, employee) => {
    if (err) console.log(err);
    res.json(employee);
  });
};
